...
function Home() {
  ...
  return (
    <div className="min-h-screen" data-id="yudhsgtsl" data-path="pages/Home.js">
      ...
      <AboutSection data-id="aboutsection1" data-path="pages/Home.js" />
      <StatisticsSection data-id="statssection1" data-path="pages/Home.js" />
      ...
      <CallToAction data-id="calltoaction1" data-path="pages/Home.js" />
    </div>);
