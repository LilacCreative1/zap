...
function InterfaceDemo() {
  ...
  // Sample ICAC investigation conversation for demo
  const conversation = [
  { id: 1, sender: "officer", text: "Mr. Johnson, I'm investigating online activities associated with your IP address. Do you share your home internet with anyone else?" },
  { id: 2, sender: "suspect", text: "No, I live alone. What's this about? Why are you asking about my internet?" },
  { id: 3, sender: "officer", text: "We've identified concerning online communications with minors coming from your network. Can you explain your online activities last Tuesday evening?" },
  { id: 4, sender: "suspect", text: "I was just chatting with friends. I talk to lots of people online. I didn't do anything wrong." },
  { id: 5, sender: "officer", text: "The conversations we've reviewed include requests for photos from someone you believed was 14 years old. Are you aware that's illegal?" },
  { id: 6, sender: "suspect", text: "I thought they were just joking about their age. People pretend to be all kinds of things online. I would never actually meet anyone underage." },
  { id: 7, sender: "officer", text: "We've gathered evidence including chat logs and account information. I'd like to review these with you and get your side of the story." }];
      ...
      <div className="container mx-auto px-4" data-id="jpi7q6n9f" data-path="components/InterfaceDemo.js">
        <div className="text-center mb-12" data-id="mi2c5fy9o" data-path="components/InterfaceDemo.js">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto" data-id="vyoxmdj9f" data-path="components/InterfaceDemo.js">
            Our AI-powered platform simulates realistic ICAC suspect interviews, helping investigators practice effective questioning techniques and evidence presentation in a secure, controlled environment.
          </p>
        </div>
          ...
          <div className={`bg-white rounded-lg shadow-xl overflow-hidden transition-all duration-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`} data-id="dtyc6kvtn" data-path="components/InterfaceDemo.js">
            ...
            <div className="bg-darkBlue text-white p-4 flex items-center justify-between" data-id="f5m5qtz6l" data-path="components/InterfaceDemo.js">
              <div className="flex items-center" data-id="ay4tkitem" data-path="components/InterfaceDemo.js">
                ...
                <div data-id="9yvyyx0ab" data-path="components/InterfaceDemo.js">
                  <h3 className="font-semibold" data-id="b25xrm77v" data-path="components/InterfaceDemo.js">Fictional ICAC Suspect #429</h3>
            ...
            <div className="p-4 border-t border-gray-200" data-id="n18j1olnc" data-path="components/InterfaceDemo.js">
              ...
              <div className="mt-3 flex justify-between text-xs text-gray-500" data-id="g1l67rvlg" data-path="components/InterfaceDemo.js">
                <span data-id="8ctuhfsr0" data-path="components/InterfaceDemo.js">This is a fictional simulation for law enforcement training only</span>
