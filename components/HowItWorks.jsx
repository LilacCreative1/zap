...
function HowItWorks() {
  ...
  // Step data with ICAC focus
  const steps = [
  {
    id: 1,
    title: "Select ICAC Scenario",
    description: "Choose from specialized scenarios focused on internet crimes against children cases with varying digital evidence elements.",
    icon: "fa-file-alt"
  },
  {
    id: 2,
    title: "Apply ICAC Techniques",
    description: "Practice trauma-informed questioning and digital evidence integration techniques using our AI-driven suspect simulation.",
    icon: "fa-comments"
  },
  {
    id: 3,
    title: "Receive Specialized Feedback",
    description: "Get evaluated on ICAC-specific competencies including digital forensic awareness and trauma-informed interviewing approach.",
    icon: "fa-chart-bar"
  }];
      ...
      <div className="container mx-auto px-4 md:px-6" data-id="oufsdfhhr" data-path="components/HowItWorks.js">
        <div className="text-center mb-12 md:mb-16" data-id="9hf2418vn" data-path="components/HowItWorks.js">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto" data-id="bnlxltifa" data-path="components/HowItWorks.js">
            Our platform provides a structured approach specifically designed for ICAC investigations, helping you improve specialized interviewing skills in a safe and controlled environment.
          </p>
        </div>
        ...
        <div className="mt-12 text-center" data-id="mrfvgnw6u" data-path="components/HowItWorks.js">
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto" data-id="ipkta4bm7" data-path="components/HowItWorks.js">
            Our AI-powered system integrates best practices for ICAC investigations, including digital evidence handling, suspect engagement strategies, and trauma-informed approaches to help you refine your specialized interviewing techniques.
          </p>
