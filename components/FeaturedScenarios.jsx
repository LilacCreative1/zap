...
function FeaturedScenarios() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 md:py-24 bg-white transition-all duration-1000 ease-out transform translate-y-10 opacity-0" data-id="lv1fawgt2" data-path="components/FeaturedScenarios.js">
      ...
      <div className="container mx-auto px-4 md:px-6" data-id="akmg22zc0" data-path="components/FeaturedScenarios.js">
        <div className="text-center mb-12" data-id="ik7j50v9m" data-path="components/FeaturedScenarios.js">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto" data-id="bs1bh2o7v" data-path="components/FeaturedScenarios.js">
            Explore our specially designed ICAC investigation scenarios, developed with law enforcement experts to enhance your digital forensic interviewing techniques.
          </p>
        </div>
